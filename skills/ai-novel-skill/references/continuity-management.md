...
在工作区已存在 `continuity/data/`，或用户要求长期续写、迁移 YAML 连续性、SQLite 检索或恢复检查点时读取本页。
...
- id: fact-001
  text: "主角在第3章获得了超能力"
  category: "completed"  # completed / revealed / state_changed
  chapter_order: 3
...
- id: resource-001
  ...
  type: "item"
  acquired_chapter: 5
  status: "in_possession"  # in_possession / lost / consumed
  owner: "protagonist"
```
