...
| # | 任务 | 优先级 | 预估 | 状态 |
| --- | --- | --- | --- | --- |
| T1 | Novel 模型宽表审计（A/B/C 分类） | P0 | 1h | ✅ 完成 |
| T2 | 非核心模型依赖分析（drama-forge、comic） | P0 | 1h | ✅ 完成 |
| T3 | 多 schema 技术可行性评估 | P0 | 1h | ✅ 完成 |
| T4 | 宽表收敛实施（B 类字段 → JSON） | P1 | 1.5h | ✅ 完成 |
| T5 | 迁移历史统一/精简 | P1 | 1h | ✅ 完成 |
| T6 | Schema 增长治理规则文档化 | P1 | 30min | ✅ 完成 |
| T7 | 全量验证 | P0 | 30min | ✅ 完成 |
