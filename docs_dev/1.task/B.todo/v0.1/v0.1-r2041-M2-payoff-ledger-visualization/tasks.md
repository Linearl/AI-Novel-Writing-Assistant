...
| # | 任务 | 优先级 | 预估 | 状态 |
| --- | --- | --- | --- | --- |
| T7 | auto-director 章节生成后：伏笔埋设检测（分析生成内容，提取新伏笔写入 ledger） | P0 | 3h | ⬜ 待开始 |
| T8 | auto-director 章节生成前：未回收伏笔检查 + 回收提醒注入 | P0 | 2h | ⬜ 待开始 |
| T9 | auto-director 集成测试 | P1 | 1.5h | ⬜ 待开始 |
