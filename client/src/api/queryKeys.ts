export const queryKeys = {
  novels: {
    ...
    chapterRepairVersions: (id: string, chapterId: string) => ["novels", "chapter-repair-versions", id, chapterId] as const,
    ...
    structuredOutline: (id: string) => ["novels", "structured-outline", id] as const,
  ...
  styleEngine: {
    ...
    novelTechniqueBindings: (id: string) => ["style-engine", "novel-technique-bindings", id] as const,
  },
  genres: {
    all: ["genres"] as const,
  },
