...
const releaseNotesPath = path.join(repoRoot, "docs", "6.changelog", "releases", "release-notes.md");
...
function extractDatedReleaseNoteBlocks(markdown) {
  ...
  if (headings.length === 0) {
    throw new Error("No date heading like '### 2026-05-08' was found in docs/6.changelog/releases/release-notes.md.");
  }
