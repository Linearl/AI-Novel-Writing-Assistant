...
| **角色准备** | `/novels/:id/characters` | AI 阵容方案、角色分级（lead/major/named/extra）、关系网、动态系统 |
...
| **本书世界同步** | — | 每本小说绑定自己的世界上下文，支持自动/手动对比同步 |
...
| **反馈中心** | `/feedback` | 用户反馈收集与 AI Issue 生成 |
