---
description: "REQ-2057 任务清单：LLM 限流器 TPM/RPM 增强"
reqId: 2057
type: tasks
status: pending
created: 2026-07-18
...
# 任务清单：LLM 限流器 TPM/RPM 增强

## 阶段一：Schema 与存储层

- [ ] **T1** ProviderSecret schema 新增 rpm/tpm 字段
...
4. 设置页可配置 rpm/tpm，默认值预填
5. 已有 provider 记录使用默认值，无需手动迁移
