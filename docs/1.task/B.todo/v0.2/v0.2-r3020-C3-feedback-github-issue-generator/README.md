---
description: "REQ-3020 用户反馈→AI 生成 GitHub Issue 任务总线"
...
| ---- | ---- | -------- |
| `README.md` | 本任务总线 | 否 |
| `REQ-3020-feedback-github-issue-generator-original.md` | 需求原始冻结副本 | 否 |
| `REQ-3020-feedback-github-issue-generator.md` | 需求工作副本 | 否 |
| `tasks.md` | 任务拆解 | 否 |
| `design.md` | 方案设计 | 否 |
...
| 2026-07-16 | ✅ 进行中 | T1-T5 代码已实现，状态审计完成 |
...
- [x] T1: 前端上下文收集器
- [x] T2: FAB 浮动按钮 + 反馈表单弹窗
- [x] T3: 后端 AI Issue 生成端点
- [x] T4: Issue 生成 Prompt 注册
- [x] T5: 前端预览 + 复制 + 跳转
- [x] T6: 联调 + 端到端验证
