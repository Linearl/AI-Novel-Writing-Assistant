...
- [x] 定位 worlds 模块中所有 `window.confirm` 调用
- [x] 替换为 `useConfirm` hook
- [x] 确保 `await` 正确处理
- [x] `pnpm typecheck` 通过
...
- [x] 定位 characters 模块中所有 `window.confirm` 调用
- [x] 替换为 `useConfirm` hook
- [x] 确保 `await` 正确处理
- [x] `pnpm typecheck` 通过
...
- [x] 定位 6 个文件中的 `window.confirm` 调用
- [x] 替换为 `useConfirm` hook
- [x] 确保 `await` 正确处理
- [x] `pnpm typecheck` 通过
...
- [x] 定位 4 个文件中的 `window.confirm` 调用
- [x] 替换为 `useConfirm` hook
- [x] 确保 `await` 正确处理
- [x] `pnpm typecheck` 通过
...
### T7: 迁移 knowledge 模块
- [x] 定位 2 个文件中的 `window.confirm` 调用
- [x] 替换为 `useConfirm` hook
- [x] `pnpm typecheck` 通过
...
- [x] 定位 autoDirector 相关文件中的 `window.confirm` 调用
- [x] 替换为 `useConfirm` hook
- [x] 验证自动导演流程中确认操作正常
- [x] `pnpm typecheck` 通过
