...
| # | 任务 | 优先级 | 预估 | 状态 |
| --- | --- | --- | --- | --- |
| T16 | 章节列表：显示字数目标范围（min~max） | P0 | 1.5h | ✅ 完成 |
| T17 | 章节列表：实际字数 vs 目标范围可视化对比（进度条或颜色标识） | P1 | 1.5h | ✅ 完成 |
| T18 | 水文标记：水文超标章节在列表中标红或警告 | P1 | 1h | ✅ 完成 |
...
| 2026-07-04 | Phase 6（T16-T18）client UI — 字数目标展示 + 对比可视化 + 水文标记 | 完成 |
