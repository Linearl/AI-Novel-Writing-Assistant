...
> 见 [REQ-3020-feedback-github-issue-generator.md](./REQ-3020-feedback-github-issue-generator.md) 第 4 节。

## 任务清单

| # | 任务 | 优先级 | 预估 | 状态 |
| --- | --- | --- | --- | --- |
| T1 | 前端上下文收集器 | P0 | 2h | ✅ 已完成 |
| T2 | FAB 浮动按钮 + 反馈表单弹窗 | P0 | 3h | ✅ 已完成 |
| T3 | 后端 AI Issue 生成端点 | P1 | 2h | ✅ 已完成 |
| T4 | Issue 生成 Prompt 注册 | P1 | 1h | ✅ 已完成 |
| T5 | 前端预览 + 复制 + 跳转 | P1 | 2h | ✅ 已完成 |
| T6 | 联调 + 端到端验证 | P1 | 1h | 🟡 已验证 |
...
| 2026-07-16 | T1-T5 代码已实现，状态审计完成 | ✅ |

---

## 完成判定

- T1~T6 全部完成且 DoD 全部满足后，REQ-3020 达到"已完成"状态。
