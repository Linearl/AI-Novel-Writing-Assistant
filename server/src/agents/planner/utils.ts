...
const INTENT_ALIAS_MAP: Record<string, string> = {
  ...
  narrative_advice: "narrative_advisor",
  rhythm_analysis: "narrative_advisor",
  character_arc_analysis: "narrative_advisor",
  theme_analysis: "narrative_advisor",
  structure_analysis: "narrative_advisor",
  narrative_structure: "narrative_advisor",
  writing_discussion: "narrative_advisor",
  story_analysis: "narrative_advisor",
  plot_analysis: "narrative_advisor",
  叙事分析: "narrative_advisor",
  创作讨论: "narrative_advisor",
  节奏分析: "narrative_advisor",
  角色分析: "narrative_advisor",
  主题分析: "narrative_advisor",
  结构分析: "narrative_advisor",
  叙事顾问: "narrative_advisor",
  伏笔分析: "narrative_advisor",
};
