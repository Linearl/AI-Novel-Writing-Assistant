...
export function buildManualEditRecommendation(impact: import("@ai-novel/shared/types/directorRuntime").DirectorManualEditImpact): DirectorWorkspaceAnalysis["recommendation"] {
