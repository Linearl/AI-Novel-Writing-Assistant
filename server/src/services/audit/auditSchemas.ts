import { z } from "zod";
import type { QualityScore, ReviewIssue, AuditType } from "@ai-novel/shared";
...
const auditReportOutputSchema = z.object({
  auditType: z.enum(["continuity", "character", "plot", "mode_fit", "vocabulary"]).transform((v) => v as AuditType),
