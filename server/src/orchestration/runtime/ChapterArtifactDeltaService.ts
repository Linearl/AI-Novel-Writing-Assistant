...
import { compactText } from "../../services/character/resource/characterResourceShared"
import { novelFactService, type NovelFactWriteItem } from "../../services/novel/fact/NovelFactService"
import { extractFacts } from "../../services/novel/novelP0Utils"
...
export class ChapterArtifactDeltaService {
  ...
  private async applyPayoffDeltas(input: {
    ...
    const { resolveSnapshotChapterReference } = await import("../../services/state/StateService");
    const { clearStaleRiskSignal, dedupeRiskSignals, serializeLedgerJson } = await import("../../services/payoff/payoffLedgerShared");
