...
import { DirectorBookAutomationProjectionService } from "../services/novel/director/projections/DirectorBookAutomationProjectionService";
import { DirectorCommandService } from "../services/novel/director/commands/DirectorCommandService";
import { DirectorTaskSnapshotService } from "../services/novel/director/projections/DirectorTaskSnapshotService";
import { NovelDirectorService } from "../services/novel/director/NovelDirectorService";
import { novelDirectorIdeaInspirationService } from "../services/novel/director/NovelDirectorIdeaInspirationService";
import { directorPersistedCandidateSchema } from "../services/novel/director/runtime/novelDirectorSchemas";
import { DIRECTOR_AUTO_EXECUTION_MODES, DIRECTOR_CORRECTION_PRESETS, DIRECTOR_RUN_MODES, DIRECTOR_TAKEOVER_ENTRY_STEPS, DIRECTOR_TAKEOVER_START_PHASES, DIRECTOR_TAKEOVER_STRATEGIES, type DirectorIdeaInspirationRequest, type DirectorIdeaInspirationsResponse, type DirectorCandidatePatchRequest, type DirectorCandidateTitleRefineRequest, type DirectorConfirmRequest, type DirectorRefinementRequest, type DirectorRunMode, type DirectorTakeoverRequest, BOOK_FRAMING_COMMERCIAL_TAG_MAX_LENGTH, BOOK_FRAMING_MAX_COMMERCIAL_TAGS, DIRECTOR_POLICY_MODES, DIRECTOR_AUTO_APPROVAL_POINTS } from "@ai-novel/shared";
import type { DirectorBookAutomationProjectionResponse, DirectorCommandAcceptedResponse, DirectorManualEditImpactResponse, DirectorPolicyMode, DirectorRuntimePolicyUpdateRequest, DirectorTaskFactInspectionResponse, DirectorTaskSnapshotResponse, DirectorWorkspaceAnalysisResponse, ApiResponse } from "@ai-novel/shared";
