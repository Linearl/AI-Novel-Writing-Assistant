/**
 * REQ-7056: Character consistency prompts.
 *
 * Prompt assets for character state extraction and contradiction detection.
 * These are registered in the prompt registry and used by the CharacterConsistencyService.
 */
...
// ─── Schema re-exports from service layer ───────────────────────────────
...
> = {
  ...
  outputSchema: characterStateExtractionOutputSchema as unknown as z.ZodType<CharacterStateExtractionOutput>,
  render: (input) => [
    new SystemMessage([
...
> = {
  ...
  outputSchema: contradictionDetectionOutputSchema as unknown as z.ZodType<ContradictionDetectionOutput>,
  render: (input) => [
    new SystemMessage([
