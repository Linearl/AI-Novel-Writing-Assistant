...
> = {
  ...
  render: (input, context) => [
    new SystemMessage([
      ...
      "【硬性要求】",
      "1. beats 必须输出 5-8 条。",
      "2. 每个 beat 都必须完整包含 key、label、summary、chapterSpanHint、mustDeliver、tensionLevel 六个字段，不能缺漏、不能改名。",
      ...
      "10. tensionLevel 必须是 low / medium / high / climax 之一，反映该 beat 的节奏张力：",
      "    - low：信息铺垫、世界观展开、日常过渡，读者压力最低。",
      "    - medium：常规推进、小冲突、试探与布局，保持阅读节奏。",
      "    - high：重要冲突升级、关键反转、角色面临重大抉择，读者压力显著。",
      "    - climax：卷内最高潮事件、终极对决、核心承诺兑现，读者压力最大。",
      "    整卷 beats 的 tensionLevel 应呈现先抑后扬的节奏弧线，开卷和收尾通常为 low/medium，高潮段为 high/climax。",
      "",
      "【卷骨架承接要求】",
