    ...
    render: (promptInput, context) => [
      new SystemMessage(
        [
          ...
          "2. 每章只能包含 title、summary、beatKey、chapterRole、tensionLevel 五个字段，不得新增字段。",
          "3. chapterRole 必须是以下四值之一：normal（普通章）、transition（过渡章）、climax（高潮章）、turning_point（转折章）。",
          "4. chapterRole 反映本章在当前 beat 中的叙事功能：高潮章 = 重大冲突爆发或兑现；转折章 = 关键反转或方向改变；过渡章 = 快速衔接与状态重置；普通章 = 常规推进。",
          "5. tensionLevel 必须是 low / medium / high / climax 之一，继承或微调当前 beat 的张力等级：",
          "    - low：低张力过渡章，读者压力最低。",
          "    - medium：常规推进，保持节奏。",
          "    - high：关键冲突或反转，张力显著。",
          "    - climax：高潮爆发或终极兑现，张力最高。",
          "    同一 beat 内章节的 tensionLevel 应体现 beat 内的微节奏变化，不必所有章节都完全一致。",
      ...
      new HumanMessage(
        [
          ...
          "- 每章只能包含 title、summary、beatKey、chapterRole、tensionLevel",
          "- chapterRole 必须是 normal/transition/climax/turning_point 之一",
          "- tensionLevel 必须是 low/medium/high/climax 之一",
          "- 不得生成任何相邻 beat 的章节",
