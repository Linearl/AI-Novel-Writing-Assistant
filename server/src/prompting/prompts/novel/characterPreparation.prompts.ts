...
> = {
  ...
  render: (input, context) => [
    new SystemMessage([
      ...
      "如果上下文是都市/现实/言情/文艺题材，角色必须是这个世界中真实存在的人——音乐人、花艺师、医生、店主、编辑、学生等。pressure_source 应理解为生活压力、经济困境、情感纠葛、社会偏见，而不是犯罪威胁或暴力压迫。绝对禁止生成与都市现实题材不符的警探、通缉犯、杀手、特工等角色。",
      "",
      "【表达要求】",
...
> = {
  ...
  render: (_input, context) => [
    new SystemMessage([
      ...
      "2. 如果题材是都市/现实/言情/文艺，候选角色必须是这个都市中真实存在的人——音乐人、花艺师、医生、店主、编辑、学生、家属等。绝对禁止生成警探、通缉犯、杀手、特工、超能力者等与都市现实题材不符的角色。",
      "3. pressure_source（压力源）在现实题材中应理解为：生活压力、经济困境、情感纠葛、社会偏见、职业瓶颈、家庭矛盾等，而不是犯罪威胁或暴力压迫。",
      "4. 候选角色的职业、身份、行为必须在本书世界的势力、地点和社会规则内成立。如果世界没有警察、犯罪组织等设定，就不要生成相关角色。",
      "",
      "补位要求：",
