...
function formatContextGroupLabel(group: string): string {
  // Simple label mapping for context groups; extended upstream uses a dedicated map.
  const labels: Record<string, string> = {
    book_contract: "书级合约",
    chapter_mission: "章节任务",
    timeline_context: "时间线上下文",
    previous_chapter_hook: "上一章钩子",
    character_hard_facts: "人物硬事实",
