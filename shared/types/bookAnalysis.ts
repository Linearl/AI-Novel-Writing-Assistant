...
export interface BookAnalysisCharacterProfileAppearance {
  summary: string;
  features: string[];
  clothing: string[];
  descriptors?: string[];
...
export interface BookAnalysisCharacterProfilePersonality {
  traits: string[];
  temperament: string;
  archetype: string;
  mbti?: string;
...
export interface BookAnalysisCharacterProfileBackground {
  history: string;
  origin: string;
  occupation: string;
  family?: string;
...
export interface BookAnalysisCharacterProfileMotivation {
  goals: string[];
  drives: string;
  conflicts: string[];
...
export interface BookAnalysisCharacterProfileRelationship {
  name?: string;
  relation: string;
  dynamic: string;
}

export interface BookAnalysisCharacterProfileRelationships {
  allies: BookAnalysisCharacterProfileRelationship[];
  rivals: BookAnalysisCharacterProfileRelationship[];
  lovers: BookAnalysisCharacterProfileRelationship[];
  mentors: BookAnalysisCharacterProfileRelationship[];
  family?: BookAnalysisCharacterProfileRelationship[];
}

export interface BookAnalysisCharacterProfileArc {
...
export interface BookAnalysisCharacterProfileSpeech {
  catchphrases: string[];
  tone: string;
  vocabulary: string;
  patterns?: string[];
...
export interface BookAnalysisCharacterProfileBehavior {
  patterns: string[];
  habits: string[];
  quirks: string[];
}

export interface BookAnalysisCharacterProfileSymbolism {
  themes: string[];
  metaphors: string[];
  narrativeRole: string;
}

export interface BookAnalysisCharacterProfileWeaknesses {
  flaws: string[];
  fears: string[];
  limitations: string[];
}

export interface BookAnalysisCharacterProfileSkills {
  talents: string[];
  expertise: string[];
  powers: string[];
}

export interface BookAnalysisCharacterProfileSocialStatus {
  class: string;
  influence: string;
  reputation: string;
  title?: string;
...
export interface BookAnalysisCharacterProfile {
  appearance: BookAnalysisCharacterProfileAppearance;
  personality: BookAnalysisCharacterProfilePersonality;
  background: BookAnalysisCharacterProfileBackground;
  motivation: BookAnalysisCharacterProfileMotivation;
  relationships: BookAnalysisCharacterProfileRelationships;
  arc: BookAnalysisCharacterProfileArc;
  speech: BookAnalysisCharacterProfileSpeech;
  behavior: BookAnalysisCharacterProfileBehavior;
  symbolism: BookAnalysisCharacterProfileSymbolism;
  weaknesses: BookAnalysisCharacterProfileWeaknesses;
  skills: BookAnalysisCharacterProfileSkills;
  socialStatus: BookAnalysisCharacterProfileSocialStatus;
...
export interface BookAnalysisCharacterAppearance {
  ...
  excerpt: string;
  parsedTraits?: Record<string, unknown> | null;
  orderIndex: number;
  createdAt: string;
}
...
export interface BookAnalysisCharacterMedia {
  id: string;
  characterId: string;
  mediaType: string;
  url: string;
